...
export const WSWrapper = (props) => {
  ...
  // enviar cartão de voto selecionado
  useEffect(() => {
  ...
  // enviar solicitação de revelação de cartão
  useEffect(() => {
    if (
  ...
  // enviar solicitação de redefinição de votação
  useEffect(() => {
    if (
  ...
  // enviar solicitação de kick do usuário
  useEffect(() => {
    if (
